...
type
  ...
  HomeState:
    Record
      state: enum { H_M, H_E, H_S, H_I, H_SD }; 		
      owner: Node;	
...
-- Debug output may be helpful:
  ...
  case H_M:
    ...
    case GetS:
      AddToSharersList(HomeNode.owner);
      AddToSharersList(msg.src);
      Send(Fwd_GetS, HomeNode.owner, msg.src, VC2, UNDEFINED, 0);
      HomeNode.state := H_SD;
  ...
  case H_I:
    ...
    case GetS:
      HomeNode.state := H_E;     
      HomeNode.owner := msg.src;;    
      Send(XData, msg.src, HomeType, VC2, HomeNode.val, 0);   
